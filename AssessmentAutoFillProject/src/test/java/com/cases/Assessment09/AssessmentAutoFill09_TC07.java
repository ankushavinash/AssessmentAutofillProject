...
public class AssessmentAutoFill09_TC07 extends Base {

    public WebDriver driver;
    public Actions actions;

    private Logger log = LogManager.getLogger(AssessmentAutoFill09_TC07.class.getName());
    ...
    @Test
    public void AssessmentAutoFill_09_TC7() throws InterruptedException, FilloException, IOException {
