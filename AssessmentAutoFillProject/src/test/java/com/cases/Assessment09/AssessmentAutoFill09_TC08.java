...
public class AssessmentAutoFill09_TC08 extends Base {

    public WebDriver driver;
    public Actions actions;

    private Logger log = LogManager.getLogger(AssessmentAutoFill09_TC08.class.getName());
    ...
    @Test
    public void AssessmentAutoFill_09_TC8() throws InterruptedException, FilloException, IOException {
