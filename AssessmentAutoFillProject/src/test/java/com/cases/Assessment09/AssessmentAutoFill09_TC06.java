...
public class AssessmentAutoFill09_TC06 extends Base {

    public WebDriver driver;
    public Actions actions;

    private Logger log = LogManager.getLogger(AssessmentAutoFill09_TC06.class.getName());
    ...
    @Test
    public void AssessmentAutoFill_09_TC6() throws InterruptedException, FilloException, IOException {
