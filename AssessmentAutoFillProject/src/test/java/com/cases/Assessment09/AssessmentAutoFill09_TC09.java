...
public class AssessmentAutoFill09_TC09 extends Base {

    public WebDriver driver;
    public Actions actions;

    private Logger log = LogManager.getLogger(AssessmentAutoFill09_TC09.class.getName());
    ...
    @Test
    public void AssessmentAutoFill_09_TC9() throws InterruptedException, FilloException, IOException {
