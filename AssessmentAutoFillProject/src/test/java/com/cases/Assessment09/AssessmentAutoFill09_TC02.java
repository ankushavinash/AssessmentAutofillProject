...
public class AssessmentAutoFill09_TC02 extends Base {

    public WebDriver driver;
    public Actions actions;

    private Logger log = LogManager.getLogger(AssessmentAutoFill09_TC02.class.getName());
    ...
    @Test
    public void AssessmentAutoFill_09_TC2() throws InterruptedException, FilloException, IOException {
