...
public class AssessmentAutoFill09_TC03 extends Base {

    public WebDriver driver;
    public Actions actions;

    private Logger log = LogManager.getLogger(AssessmentAutoFill09_TC03.class.getName());
    ...
    @Test
    public void AssessmentAutoFill_09_TC3() throws InterruptedException, FilloException, IOException {
