...
public class AssessmentAutoFill09_TC10 extends Base {

    public WebDriver driver;
    public Actions actions;

    private Logger log = LogManager.getLogger(AssessmentAutoFill09_TC10.class.getName());
    ...
    @Test
    public void AssessmentAutoFill_09_TC10() throws InterruptedException, FilloException, IOException {
