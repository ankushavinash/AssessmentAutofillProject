...
public class AssessmentAutoFill09_TC05 extends Base {

    public WebDriver driver;
    public Actions actions;

    private Logger log = LogManager.getLogger(AssessmentAutoFill09_TC05.class.getName());
    ...
    @Test
    public void AssessmentAutoFill_09_TC5() throws InterruptedException, FilloException, IOException {
