...
public class AssessmentAutoFill09_TC04 extends Base {

    public WebDriver driver;
    public Actions actions;

    private Logger log = LogManager.getLogger(AssessmentAutoFill09_TC04.class.getName());
    ...
    @Test
    public void AssessmentAutoFill_09_TC4() throws InterruptedException, FilloException, IOException {
