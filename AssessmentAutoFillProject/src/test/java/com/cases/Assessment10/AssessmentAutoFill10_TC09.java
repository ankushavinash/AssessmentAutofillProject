...
public class AssessmentAutoFill10_TC09 extends Base {

    public WebDriver driver;
    public Actions actions;

    private Logger log = LogManager.getLogger(AssessmentAutoFill10_TC09.class.getName());
    ...
    @Test
    public void AssessmentAutoFill_10_TC9() throws InterruptedException, FilloException, IOException {
