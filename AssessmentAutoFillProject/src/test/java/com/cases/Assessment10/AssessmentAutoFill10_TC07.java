...
public class AssessmentAutoFill10_TC07 extends Base {

    public WebDriver driver;
    public Actions actions;

    private Logger log = LogManager.getLogger(AssessmentAutoFill10_TC07.class.getName());
    ...
    public void initialize() throws IOException, FilloException {
        ...
        data = new Utils().getTestData("TC07");
        actions = new Actions(driver);

    }

    @Test
    public void AssessmentAutoFill_10_TC7() throws InterruptedException, FilloException, IOException {
