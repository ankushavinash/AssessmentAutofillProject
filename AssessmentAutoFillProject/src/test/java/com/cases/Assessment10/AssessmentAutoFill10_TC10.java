package com.cases.Assessment10;
...
public class AssessmentAutoFill10_TC10 extends Base {

    public WebDriver driver;
    public Actions actions;

    private Logger log = LogManager.getLogger(AssessmentAutoFill10_TC10.class.getName());
    ...
    public void initialize() throws IOException, FilloException {
        ...
        data = new Utils().getTestData("TC10");
        actions = new Actions(driver);

    }

    @Test
    public void AssessmentAutoFill_10_TC10() throws InterruptedException, FilloException, IOException {
