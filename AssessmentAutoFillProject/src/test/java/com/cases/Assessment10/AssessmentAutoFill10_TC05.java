...
public class AssessmentAutoFill10_TC05 extends Base {

    public WebDriver driver;
    public Actions actions;

    private Logger log = LogManager.getLogger(AssessmentAutoFill10_TC05.class.getName());
    ...
    public void initialize() throws IOException, FilloException {
        ...
        data = new Utils().getTestData("TC05");
        actions = new Actions(driver);

    }

    @Test
    public void AssessmentAutoFill_10_TC5() throws InterruptedException, FilloException, IOException {
