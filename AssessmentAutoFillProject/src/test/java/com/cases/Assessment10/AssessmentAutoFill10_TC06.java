...
public class AssessmentAutoFill10_TC06 extends Base {

    public WebDriver driver;
    public Actions actions;

    private Logger log = LogManager.getLogger(AssessmentAutoFill10_TC06.class.getName());
    ...
    public void initialize() throws IOException, FilloException {
        ...
        data = new Utils().getTestData("TC06");
        actions = new Actions(driver);

    }

    @Test
    public void AssessmentAutoFill_10_TC6() throws InterruptedException, FilloException, IOException {
