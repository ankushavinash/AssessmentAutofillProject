...
public class AssessmentAutoFill10_TC03 extends Base {

    public WebDriver driver;
    public Actions actions;

    private Logger log = LogManager.getLogger(AssessmentAutoFill10_TC03.class.getName());
    ...
    @Test
    public void AssessmentAutoFill_10_TC3() throws InterruptedException, FilloException, IOException {
