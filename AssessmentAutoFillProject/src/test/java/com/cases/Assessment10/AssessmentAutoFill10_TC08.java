...
public class AssessmentAutoFill10_TC08 extends Base {

    public WebDriver driver;
    public Actions actions;

    private Logger log = LogManager.getLogger(AssessmentAutoFill10_TC08.class.getName());
    ...
    public void initialize() throws IOException, FilloException {
        ...
        data = new Utils().getTestData("TC08");
        actions = new Actions(driver);

    }

    @Test
    public void AssessmentAutoFill_10_TC8() throws InterruptedException, FilloException, IOException {
