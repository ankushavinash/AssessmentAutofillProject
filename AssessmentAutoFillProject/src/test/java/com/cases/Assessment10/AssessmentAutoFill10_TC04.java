...
public class AssessmentAutoFill10_TC04 extends Base {

    public WebDriver driver;
    public Actions actions;

    private Logger log = LogManager.getLogger(AssessmentAutoFill10_TC04.class.getName());
    ...
    public void initialize() throws IOException, FilloException {
        ...
        data = new Utils().getTestData("TC04");
        actions = new Actions(driver);

    }

    @Test
    public void AssessmentAutoFill_10_TC4() throws InterruptedException, FilloException, IOException {
