...
public class AssessmentAutoFill10_TC02 extends Base {

    public WebDriver driver;
    public Actions actions;

    private Logger log = LogManager.getLogger(AssessmentAutoFill10_TC02.class.getName());
    ...
    public void initialize() throws IOException, FilloException {
        ...
        data = new Utils().getTestData("TC02");
        actions = new Actions(driver);

    }

    @Test
    public void AssessmentAutoFill_10_TC2() throws InterruptedException, FilloException, IOException {
