...
public class AssessmentAutoFill10_TC01 extends Base {

    public WebDriver driver;
    public Actions actions;

    private Logger log = LogManager.getLogger(AssessmentAutoFill10_TC01.class.getName());
    ...
    @Test
    public void AssessmentAutoFill_10_TC1() throws InterruptedException, FilloException, IOException {
