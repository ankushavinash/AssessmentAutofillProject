...
public class AssessmentAutoFill12_TC01 extends Base {

    public WebDriver driver;
    public Actions actions;

    private Logger log = LogManager.getLogger(AssessmentAutoFill12_TC01.class.getName());
    ...
    @Test
    public void AssessmentAutoFill_12_TC1() throws InterruptedException, FilloException, IOException {
