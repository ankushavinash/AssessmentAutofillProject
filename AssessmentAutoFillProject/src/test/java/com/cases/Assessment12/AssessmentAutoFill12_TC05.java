...
public class AssessmentAutoFill12_TC05 extends Base {

    public WebDriver driver;
    public Actions actions;

    private Logger log = LogManager.getLogger(AssessmentAutoFill12_TC05.class.getName());
    ...
    @Test
    public void AssessmentAutoFill_12_TC5() throws InterruptedException, FilloException, IOException {
