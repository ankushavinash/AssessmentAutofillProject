...
public class AssessmentAutoFill12_TC10 extends Base {

    public WebDriver driver;
    public Actions actions;

    private Logger log = LogManager.getLogger(AssessmentAutoFill12_TC10.class.getName());
    ...
    @Test
    public void AssessmentAutoFill_12_TC10() throws InterruptedException, FilloException, IOException {
