...
public class AssessmentAutoFill12_TC07 extends Base {

    public WebDriver driver;
    public Actions actions;

    private Logger log = LogManager.getLogger(AssessmentAutoFill12_TC07.class.getName());
    ...
    @Test
    public void AssessmentAutoFill_12_TC7() throws InterruptedException, FilloException, IOException {
