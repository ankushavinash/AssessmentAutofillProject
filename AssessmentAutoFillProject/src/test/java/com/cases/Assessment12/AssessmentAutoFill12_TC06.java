...
public class AssessmentAutoFill12_TC06 extends Base {

    public WebDriver driver;
    public Actions actions;

    private Logger log = LogManager.getLogger(AssessmentAutoFill12_TC06.class.getName());
    ...
    @Test
    public void AssessmentAutoFill_12_TC6() throws InterruptedException, FilloException, IOException {
