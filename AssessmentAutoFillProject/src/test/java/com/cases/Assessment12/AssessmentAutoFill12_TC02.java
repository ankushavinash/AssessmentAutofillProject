...
public class AssessmentAutoFill12_TC02 extends Base {

    public WebDriver driver;
    public Actions actions;

    private Logger log = LogManager.getLogger(AssessmentAutoFill12_TC02.class.getName());
    ...
    @Test
    public void AssessmentAutoFill_12_TC2() throws InterruptedException, FilloException, IOException {
