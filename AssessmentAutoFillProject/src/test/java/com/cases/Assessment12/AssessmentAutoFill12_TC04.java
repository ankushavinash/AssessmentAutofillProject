...
public class AssessmentAutoFill12_TC04 extends Base {

    public WebDriver driver;
    public Actions actions;

    private Logger log = LogManager.getLogger(AssessmentAutoFill12_TC04.class.getName());
    ...
    @Test
    public void AssessmentAutoFill_12_TC4() throws InterruptedException, FilloException, IOException {
