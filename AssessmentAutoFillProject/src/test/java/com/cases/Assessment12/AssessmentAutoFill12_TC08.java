...
public class AssessmentAutoFill12_TC08 extends Base {

    public WebDriver driver;
    public Actions actions;

    private Logger log = LogManager.getLogger(AssessmentAutoFill12_TC08.class.getName());
    ...
    @Test
    public void AssessmentAutoFill_12_TC8() throws InterruptedException, FilloException, IOException {
