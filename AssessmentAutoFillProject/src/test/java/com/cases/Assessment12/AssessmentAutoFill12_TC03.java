...
public class AssessmentAutoFill12_TC03 extends Base {

    public WebDriver driver;
    public Actions actions;

    private Logger log = LogManager.getLogger(AssessmentAutoFill12_TC03.class.getName());
    ...
    @Test
    public void AssessmentAutoFill_12_TC3() throws InterruptedException, FilloException, IOException {
